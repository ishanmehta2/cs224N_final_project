...
def get_candidates(crossword):
    ...
    for idx, prompt in enumerate(prompts):
        ...
        for completion in completions:
            candidates[keys[idx]].append(completion)
...
def solve(filepath, print_grid=False):
    ...
    crossword_solver.run_belief_propagation(num_iterations=10)
    ...
    truth_solution = convert_answer(crossword)
